...
```typescript
// ❌ WRONG - Raw setInterval in constructor
@Injectable()
export class CleanupService {
  constructor() {
    // ❌ No NestJS lifecycle management
...
// ✅ CORRECT - NestJS schedule decorator
...
```typescript
// ✅ REQUIRED: Import ScheduleModule
...
```typescript
// ✅ REQUIRED: Service with scheduled methods
...
export class ScheduledTasksService {
  ...
  // ✅ Run once after 10 seconds (useful for startup tasks)
  @Timeout(10000)
  handleStartupTasks() {
...
```typescript
// ✅ REQUIRED: Error handling in scheduled tasks
@Injectable()
export class ScheduledTasksService {
  private readonly logger = new Logger(ScheduledTasksService.name);
...
```typescript
// ✅ OPTIONAL: Use a lock to prevent overlapping runs
