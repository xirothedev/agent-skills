...
import { METADATA_FILE, OUTPUT_FILE, RULES_DIR, SKILL_DIR } from './config'
import { parseRuleFile, type RuleFile } from './parser'
import type { ImpactLevel, Section } from './types'
...
function generateMarkdown(
  ...
  md += `> generating, or refactoring NestJS codebases. Humans  \n`
  ...
  sections.forEach((section) => {
    md += `${section.number}. [${section.title}](#${section.number
